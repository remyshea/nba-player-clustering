...
<img src="./assets/raw_data_cluster.png" style="float: top; margin: 10px; height: 150px">
...
<img src="./assets/VIF_raw.png" style="border-radius: 5px;float: left; margin: 10px; height: 100px">
<img src="./assets/VIF_feat_eng.png" style="border-radius: 5px;float: right; margin: 10px; height: 100px">
...
<img src="./assets/feat_eng_heatmap.png" style="border-radius: 15px; float: top; margin: 10px; height: 100px">
<img src="./assets/manual_corr_heatmap.png" style="border-radius: 15px; float: top; margin: 10px; height: 75px">
